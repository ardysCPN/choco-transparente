...
export const PortalLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-slate-50 text-slate-900 selection:bg-emerald-600 selection:text-white font-sans antialiased overflow-x-hidden">
      ...
      {/* Main Header / Navbar en Fondo Claro — Ancho Completo y Ultra Responsivo en Móvil */}
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-xs shrink-0 w-full transition-all duration-150">
        <div className="w-full px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20 gap-1.5 sm:gap-4">
            {/* LADO IZQUIERDO: Logotipo e Identidad Institucional */}
            <Link to="/" className="flex items-center gap-2 sm:gap-3 group shrink min-w-0">
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-br from-emerald-600 via-sky-600 to-amber-500 p-0.5 shadow-md shadow-emerald-600/20 group-hover:scale-105 transition-transform duration-200 shrink-0">
                <div className="w-full h-full bg-white rounded-[13px] sm:rounded-[14px] flex items-center justify-center">
                  <Shield className="w-4 h-4 sm:w-6 sm:h-6 text-emerald-700 group-hover:text-amber-600 transition-colors" />
                </div>
              </div>

              <div className="min-w-0 shrink">
                <div className="font-black text-sm sm:text-lg lg:text-xl tracking-tight text-slate-900 flex items-center gap-1 leading-none whitespace-nowrap">
                  <span>CHOCÓ</span>
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-600 to-sky-600">
                    TRANSPARENTE
                  </span>
                </div>
                <div className="hidden sm:flex text-[10px] sm:text-[11px] text-slate-500 tracking-wider font-semibold uppercase mt-0.5 sm:mt-1 items-center gap-1.5">
            ...
            {/* LADO DERECHO: Acciones y Botones Siempre Visibles y Bien Espaciados */}
            <div className="flex items-center gap-1 sm:gap-2 shrink-0">
              ...
              >
                ...
                <span className="sm:hidden text-[11px]">Ayuda</span>
              </Link>
